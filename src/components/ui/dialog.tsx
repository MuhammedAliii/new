...
const Dialog = ({
  ...
  // Safety scroll-lock cleanup when dialog closes or unmounts
  React.useEffect(() => {
    if (!open && typeof document !== "undefined") {
      const timer = setTimeout(() => {
        const hasOtherOpenDialog = document.querySelector('[role="dialog"][data-state="open"]');
